...
const MoodJournal: React.FC = () => {
    ...
    const calculateMoodScore = () => {
        const weights = moodAspects.reduce(
        ...
        const positiveScore =
            ((moodAspects.find((a) => a.id === "happiness")?.value || 0) * 1.5 +
                ...
                (moodAspects.find((a) => a.id === "motivation")?.value || 0) *
                    1.0) /
            (1.5 + 1.0 + 0.8 + 1.0);
        ...
        const negativeScore =
            ((moodAspects.find((a) => a.id === "anxiety")?.value || 0) * 1.2 +
                (moodAspects.find((a) => a.id === "stress")?.value || 0) *
                    1.2) /
            (1.2 + 1.2);
    ...
    useEffect(() => {
        ...
        if (positiveScore > 80 && negativeScore < 20)
            setOverallMood("veryHappy");
        else if (positiveScore > 60 && negativeScore < 40)
            setOverallMood("happy");
                    ...
                    <TabsContent value="triggers">
                        <Card className="p-6">
                            ...
                            <div className="space-y-6">
                                {Object.entries(moodTriggers).map(
                                    ([category, triggers]) => (
                                        <div
                                            key={category}
                                            className="space-y-3"
