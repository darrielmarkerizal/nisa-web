    ...
    return (
        <Card
            ...
            style={{
                ...
                boxShadow: isHovered
                    ? "0 10px 20px rgba(255, 20, 147, 0.2)"
                    : "none",
            }}
            onMouseEnter={() => setIsHovered(true)}
            onMouseLeave={() => setIsHovered(false)}
...
const menuItems: MenuItem[] = [
    ...
    },
    {
        ...
        description: "abadikan momen spesial kita berdua",
        route: "/photobooth",
    },
    {
        icon: Gift,
                    ...
                    <div className="flex flex-col items-center justify-center space-y-4 mt-8">
                        <div className="bg-pink-50 p-4 rounded-lg max-w-md text-center">
                            <p className="text-pink-500 text-sm mb-2">
                                tombol ini buat kamu yang lagi butuh perhatian
                                dariku ya sayangkuu 🥺 klik kalau kamu pen
                                dimanja-manjain, kangen, atau butuh aku sekarang
                                jugaa!! 💝
                            </p>
                        </div>
